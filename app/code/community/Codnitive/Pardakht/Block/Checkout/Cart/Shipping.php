 ...
 * @author     Hassan Barza <support@codnitive.com>
 */
class Codnitive_Pardakht_Block_Checkout_Cart_Shipping extends Mage_Checkout_Block_Cart_Shipping
{
	...
	public function getCountryHtmlSelect($defValue=null, $name='country_id', $id='country', $title='Country')
	{
		...
		$html = $this->getLayout()->createBlock('core/html_select')
			...
			->setValue($defValue)
			->setOptions($options)
			->setExtraParams('onchange="Codnitive.pardakht.flipFields(this, \'estimate\')"')
			->getHtml();
