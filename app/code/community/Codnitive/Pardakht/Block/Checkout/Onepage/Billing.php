 ...
 * @author     Hassan Barza <support@codnitive.com>
 */
class Codnitive_Pardakht_Block_Checkout_Onepage_Billing extends Mage_Checkout_Block_Onepage_Billing
{
...
//		}
		...
		$select = $this->getLayout()->createBlock('core/html_select')
			...
			->setExtraParams('onchange="Codnitive.pardakht.flipFields(this, \'billing\')"');
		if ($type === 'shipping') {
