 ...
 * @author     Hassan Barza <support@codnitive.com>
 */
class Codnitive_Pardakht_Block_Customer_Form_Register extends Mage_Customer_Block_Form_Register
{
	...
	public function getCountryHtmlSelect($defValue=null, $name='country_id', $id='country', $title='Country')
	{
		...
		$html = $this->getLayout()->createBlock('core/html_select')
			...
			->setValue($defValue)
			->setOptions($options)
			->setExtraParams('onchange="Codnitive.pardakht.flipFields(this, \'register\')"')
			->getHtml();
