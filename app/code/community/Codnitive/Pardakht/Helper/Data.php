...
class Codnitive_Pardakht_Helper_Data extends Mage_Core_Helper_Data
{
...
//        '0' => 'Please select region, state or province',
	...
	protected $_pardakhtShippingTypes = array(
		'1' => 'ems',
		'2' => 'rms',
		'3' => 'lms'
	);

	protected $_pardakhtPaymentTypes = array(
		'pardakht'           => 'posti',
		'pardakhtonline'     => 'saman',
		'pardakhtmoneyorder' => 'havale'
	);
...
//			$this->_checkCert();
	...
	{
		return $this->_pardakhtShippingTypes;
	}
	...
	{
		$name = str_replace('pardakht_', '', $shippingMethod);
		return array_search($name, $this->getShippingTypes());
	}

	public function getPaymentTypes()
	{
		return $this->_pardakhtPaymentTypes;
	}
	...
	{
		return Mage::getStoreConfig(Codnitive_Pardakht_Model_Config::getNamespace() . 'chkfrq');
	}

	public function getLastCheck()
	{
		$namespace = Codnitive_Pardakht_Model_Config::EXTENSION_NAMESPACE;
