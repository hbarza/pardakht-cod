 ...
 */
class Codnitive_Pardakht_Model_Method_Moneyorder extends Mage_Payment_Model_Method_Abstract
{
	 ...
	 * @var string
	 */
	protected $_code  = 'pardakhtmoneyorder';
...
//	}
	...
	public function isAvailable($quote = null)
	{
		...
		$condition = !Mage::getModel('pardakht/config')->isActiveMoneyOrderPayment()
